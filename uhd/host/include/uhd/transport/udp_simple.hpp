...
public:
    ...
    static const size_t mtu = 2000 - 20 - 8; //default ipv4 mtu - ipv4 header - udp header
     ...
     */
    virtual size_t recv(const boost::asio::mutable_buffer &buff, double timeout = 0.01) = 0;
